    ...
    <div>
      <div className="w-full min-h-[300px] relative">
        <Image
          ...
          quality={90}
          alt="background"
          className="w-full h-[471px] absolute"
        />
      ...
      <div className="text-black flex flex-col justify-center items-center pb-20">
