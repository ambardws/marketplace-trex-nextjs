...
export default function Footer() {
  ...
  const logos = [
    assets.TrexMedsos.Facebook2,
    assets.TrexMedsos.Instagram,
    assets.TrexMedsos.Twitter,
    assets.TrexMedsos.Gmail,
    assets.TrexMedsos.Youtube,
  ];
  return (
    <>
      {pathname !== "/dashboard/home/menu" ? (
